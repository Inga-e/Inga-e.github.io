...
var _coachesDescription = require("./modules/coaches-description");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _coachesSwiper.swiperCoaches)();
    (0, _faqButtons.isResizePaddingBottom)();
    (0, _faqButtons.isChangeAccordionButtons)();
    (0, _faqButtons.isChangeTabButtons)();
    (0, _video.openVideo)();
    (0, _coachesDescription.isShowCoachesDescription)();
  });
});
...
},{"./modules/coaches-description":3,"./modules/coaches-swiper":4,"./modules/faq-buttons":5,"./modules/feedback-swiper":6,"./modules/form-validate/form":8,"./modules/init-accordion":14,"./modules/init-tabs":15,"./modules/video":17,"./utils/ios-vh-fix":19}],2:[function(require,module,exports){
"use strict";
...
exports.isShowCoachesDescription = void 0;
var coachesCards = document.querySelectorAll('[data-slider-trainer]');
var isShowCoachesDescription = function isShowCoachesDescription() {
...
exports.isShowCoachesDescription = isShowCoachesDescription;
...
exports.isResizePaddingBottom = exports.isChangeTabButtons = exports.isChangeAccordionButtons = void 0;
...
var tabItems = document.querySelectorAll('[data-tabs="control"]');
...
var isChangeTabButtons = function isChangeTabButtons() {
...
exports.isChangeTabButtons = isChangeTabButtons;
